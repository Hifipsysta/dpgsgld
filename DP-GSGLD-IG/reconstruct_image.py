...
if __name__ == "__main__":
    ...
    if args.dataset == 'ImageNet':
        ...
        model, model_seed = inversefed.construct_model(args.model, num_classes=32, num_channels=3)

    elif args.dataset == 'MNIST':
        model, model_seed = inversefed.construct_model(args.model, num_classes=10, num_channels=1)
    ...
    if args.save_image and not args.dryrun:
        ...
        rec_filename = (f'{args.dataset}_{args.optimizer}_{args.scale}_{args.grad_clip}'
                        f'_{args.learning_rate}-{args.max_iterations}-{args.target_id}.png')
        ...
        gt_filename = (f'{args.dataset}_ground_truth-{args.target_id}.png')
