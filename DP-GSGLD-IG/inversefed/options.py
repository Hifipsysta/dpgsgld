...
def options():
    ...
    parser.add_argument('--max_iterations', default=24000, type=int, help='Max iterations.')
    parser.add_argument('--learning_rate', default = 5e-4, type=float, help='Learning_rate')
    parser.add_argument('--scale', default = 1.0, type=float, help='Scale parameter of Gaussian')
    parser.add_argument('--grad_clip', default = 1.0, type=float, help = 'Threshold of gradient clipping')
    parser.add_argument('--device', default='cuda0', type=str, help='Choice of CUDA')
    parser.add_argument('--epsilon', default=1.0, type=float, help='Privacy budget')
    parser.add_argument('--delta', default=1e-5, type=float, help='Failure probability')
