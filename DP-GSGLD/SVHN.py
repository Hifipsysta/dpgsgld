...
train_data = torchvision.datasets.SVHN('SVHN', split='train', download=True,
...
test_data = torchvision.datasets.SVHN('SVHN', split='test', download=True,
                             transform=torchvision.transforms.Compose([
                               torchvision.transforms.ToTensor(),
                               torchvision.transforms.Normalize(
                                [0.485,0.456,0.406],[0.229,0.224,0.225])
    ...
    if (iters+1) % 10 == 0: 
        if iters == args.iterations-1:
            torchvision.utils.save_image(dummy_data[0],
                                        'assets/SVHN_'f'{args.optimizer}_{args.scale}_{args.grad_clip}_{args.iterations}_{args.img_index}.png')
