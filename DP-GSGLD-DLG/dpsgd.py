...
def sgd(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        #gradient_rec.append(d_p.norm().detach().item())
        # if i == 0:
        
        d_p = d_p + torch.normal(0.0, (scale*C), d_p.shape).to(device)
...
class DPSGD(Optimizer):
    def __init__(self, params, C, scale, batch_size, device, lr=required, 
        ...
        defaults = dict(lr=lr, C=C, scale=scale, batch_size=batch_size, 
