...
train_data = torchvision.datasets.CIFAR10('CIFAR10', train=True, download=True,
    ...
    if (iters+1) % 10 == 0: 
        if iters == args.iterations-1:
            torchvision.utils.save_image(dummy_data[0],
                                        'assets/CIFAR10_'f'{args.optimizer}_{args.scale}_{args.grad_clip}_{args.epochs}_{args.img_index}.png')
